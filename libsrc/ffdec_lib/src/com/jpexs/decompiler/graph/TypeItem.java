...
public class TypeItem extends GraphTargetItem {
	...
	public TypeItem(String s) {
		this(s == null ? new DottedChain(new String[] {}, "") : DottedChain
				.parseWithSuffix(s));
	}
	...
	public GraphTextWriter appendTo(GraphTextWriter writer, LocalData localData)
		...
		if (localData.fullyQualifiedNames.contains(DottedChain
				.parseWithSuffix(fullTypeName.getLast()))) {
			nwriter.hilightSpecial(fullTypeName.toPrintableString(as3),
					HighlightSpecialType.TYPE_NAME, fullTypeName.toRawString());
		} else {
			nwriter.hilightSpecial(
					IdentifiersDeobfuscation.printIdentifier(as3,
							fullTypeName.getLast()),
					HighlightSpecialType.TYPE_NAME, fullTypeName.toRawString());
		}
