...
public class WhileItem extends LoopItem implements Block {
	...
	public WhileItem(GraphSourceItem src, GraphSourceItem lineStartIns,
			Loop loop, List<GraphTargetItem> expression,
	...
	public GraphTextWriter appendTo(GraphTextWriter writer, LocalData localData)
		...
		nwriter.append(")");
		appendBlock(expression.get(expression.size() - 1), nwriter, localData,
				commands);
		if (nwriter instanceof NulWriter) {
