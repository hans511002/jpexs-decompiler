...
public class CLIPACTIONRECORD implements ASMSource, Serializable {
	...
	public static String keyToString(int key) {
		if ((key < CLIPACTIONRECORD.KEYNAMES.length) && (key > 0)
				&& (CLIPACTIONRECORD.KEYNAMES[key] != null)) {
	...
	public static final String[] KEYNAMES = { null, "<Left>", "<Right>",
			"<Home>", "<End>", "<Insert>", "<Delete>", null, "<Backspace>",
			null, null, null, null, "<Enter>", "<Up>", "<Down>", "<PageUp>",
			"<PageDown>", "<Tab>", "<Escape>", null, null, null, null, null,
	...
	public CLIPACTIONRECORD(SWF swf, SWFInputStream sis, Tag tag)
			throws IOException {
		this.swf = swf;
		this.tag = tag;
	...
	public GraphTextWriter getActionSourcePrefix(GraphTextWriter writer) {
		...
		nwriter.appendNoHilight(eventFlags.getHeader(keyCode, false));
