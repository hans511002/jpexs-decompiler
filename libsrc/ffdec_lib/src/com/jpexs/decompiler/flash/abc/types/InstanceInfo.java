...
public class InstanceInfo {
	...
	public int flags; // 1 = sealed, 0 = dynamic, 2 = final, 4 = interface, 8 =
	...
	public static final int CLASS_NON_NULLABLE = 16; // This is somehow used in
														// Flex, propably
														// through annotations
														// or something with
														// Vector datatype (?)
	...
	public GraphTextWriter getClassHeaderStr(GraphTextWriter writer, ABC abc,
		...
		if (interfaces.length > 0) {
			if (isInterface()) {
				...
				nwriter.appendNoHilight(" implements ");
			}
