 ...
 * @author JPEXS
 */
public class SetLocalAVM2Item extends AVM2Item implements SetTypeAVM2Item,
		AssignmentAVM2Item {
	...
	public SetLocalAVM2Item(GraphSourceItem instruction,
			GraphSourceItem lineStartIns, int regIndex, GraphTargetItem value) {
	...
	public GraphTextWriter appendTo(GraphTextWriter writer, LocalData localData)
		...
		nwriter.append(localName).append(" = ");
	...
	public GraphTargetItem getObject() {
		return new LocalRegAVM2Item(getInstruction(), getLineStartIns(),
				regIndex, null);
	}
	...
	public List<GraphSourceItem> toSource(SourceGeneratorLocalData localData,
		...
		case 3:
			...
			break;
		default:
			ins = new AVM2Instruction(0, AVM2Instructions.SetLocal,
					new int[] { regIndex });
			break;
		}
		return toSourceMerge(localData, generator, value, new AVM2Instruction(
				0, AVM2Instructions.Dup, null), ins);
	}
