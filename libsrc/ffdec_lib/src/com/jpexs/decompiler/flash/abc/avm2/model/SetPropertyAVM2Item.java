 ...
 * @author JPEXS
 */
public class SetPropertyAVM2Item extends AVM2Item implements SetTypeAVM2Item,
		AssignmentAVM2Item {
	...
	public SetPropertyAVM2Item(GraphSourceItem instruction,
			GraphSourceItem lineStartIns, GraphTargetItem object,
			GraphTargetItem propertyName, GraphTargetItem value) {
	...
	public GraphTextWriter appendTo(GraphTextWriter writer, LocalData localData)
		...
		formatProperty(nwriter, object, propertyName, localData);
		nwriter.append(" = ");
	...
	public GraphTargetItem getObject() {
		return new GetPropertyAVM2Item(getInstruction(), getLineStartIns(),
				object, propertyName);
	}
	...
	public List<GraphSourceItem> toSource(SourceGeneratorLocalData localData,
		...
		return toSourceMerge(
				...
				object,
				value,
				new AVM2Instruction(0, AVM2Instructions.SetProperty,
						new int[] { ((AVM2SourceGenerator) generator)
