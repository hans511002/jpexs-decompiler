 ...
 * @author JPEXS
 */
public class SetVariableActionItem extends ActionItem implements
		SetTypeActionItem {
	...
	public SetVariableActionItem(GraphSourceItem instruction,
	...
	public List<GraphSourceItem> toSource(SourceGeneratorLocalData localData,
		...
		try {
			return toSourceMerge(localData, generator, name, value,
					new ActionStoreRegister(tmpReg), new ActionSetVariable(),
