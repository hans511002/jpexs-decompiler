...
public class NewObjectActionItem extends ActionItem {
	...
	public NewObjectActionItem(GraphSourceItem instruction,
			GraphSourceItem lineStartIns, GraphTargetItem objectName,
	...
	public List<GraphSourceItem> toSource(SourceGeneratorLocalData localData,
		...
		return toSourceMerge(localData, generator,
				toSourceCall(localData, generator, arguments), objectName,
				new ActionNewObject());
	}
