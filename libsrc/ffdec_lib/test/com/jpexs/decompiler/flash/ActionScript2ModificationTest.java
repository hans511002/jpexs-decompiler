...
public class ActionScript2ModificationTest extends ActionScript2TestBase {
	...
	public void testRemoveActionNormal(String actionsString,
			String expectedResult, int[] actionsToRemove) {
		try {
			ActionList actions = ASMParser.parse(0, true, actionsString,
					swf.version, false);
			...
			String actualResult = normalizeLabels(writer.toText());
	...
	public void testRemoveActionFast(String actionsString,
			String expectedResult, int[] actionsToRemove) {
		try {
			ActionList actions = ASMParser.parse(0, true, actionsString,
					swf.version, false);
	...
	public void testRemoveAction(String actionsString, String expectedResult,
			int[] actionsToRemove) {
	...
	public void testAddActionNormal(String actionsString,
			String expectedResult, Action action, int index) {
		try {
			ActionList actions = ASMParser.parse(0, true, actionsString,
					swf.version, false);
	...
	public void testAddActionFast(String actionsString, String expectedResult,
	...
	public void testRemoveJumpAction() {
		String actionsString = "ConstantPool\n"
				...
				+ "Return\n" + "}\n" + "Push 2\n" + "Jump label_1\n" + // remove
																		...
																		// action
				"label_1:Push 3";
		String expectedResult = "ConstantPool\n"
				+ "DefineFunction \"test\" 1 \"p1\" {\n" + "Push 1\n"
				+ "Return\n" + "}\n" + "Push 2 3";
	...
	public void testRemoveIfTargetAction() {
		String actionsString = "ConstantPool\n"
				...
				+ "GetVariable\n" + "}\n" + "Push 2\n" + "If label_1\n"
				+ "Push 3\n" + "label_1:Push 4\n" // remove this action
				+ "Push 5"; // after removing the previous action the if action
							// should jump here
		String expectedResult = "ConstantPool\n"
				+ "DefineFunction \"test\" 1 \"p1\" {\n" + "Push 1\n"
				+ "GetVariable\n" + "}\n" + "Push 2\n" + "If label_1\n"
	...
	public void testAddAtionFirst() {
		String actionsString = "ConstantPool\n"
				...
				+ "GetVariable\n" + "}\n" + "Push 2\n" + "If label_1\n"
				+ "Push 3\n" + "label_1:Push 4";
		String expectedResult = "GetMember\n" + "ConstantPool\n"
				+ "DefineFunction \"test\" 1 \"p1\" {\n" + "Push 1\n"
				+ "GetVariable\n" + "}\n" + "Push 2\n" + "If label_1\n"
				+ "Push 3\n" + "label_1:Push 4";
		testAddActionNormal(actionsString, expectedResult,
				new ActionGetMember(), 0);
		testAddActionFast(actionsString, expectedResult, new ActionGetMember(),
				0);
	}
