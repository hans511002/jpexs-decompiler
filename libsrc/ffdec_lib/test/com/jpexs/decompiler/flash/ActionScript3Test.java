...
public class ActionScript3Test extends ActionScriptTestBase {
	...
	public void init() throws IOException, InterruptedException {
		...
		assertNotNull(tag);
		clsIndex = tag.getABC().findClassByName(
				new DottedChain(new String[] { "classes", "Test" }, ""));
	...
	private void decompileMethod(String methodName, String expectedResult,
			boolean isStatic) {
		...
		try {
			...
			abc.bodies.get(bodyIndex).convert(new ConvertData(), methodName,
					ScriptExportMode.AS, isStatic, -1/* FIX? */, -1/* FIX? */,
					clsIndex, abc, null, new ScopeStack(), 0, new NulWriter(),
					new ArrayList<>(), ts, true);
			writer = new HighlightedTextWriter(new CodeFormatting(), false);
			abc.bodies.get(bodyIndex).toString(methodName, ScriptExportMode.AS,
					abc, null, writer, new ArrayList<>());
	...
	private void decompileScriptPack(String path, String expectedResult) {
		ScriptPack scriptPack = abc.findScriptPackByPath(path,
				Arrays.asList(abc));
	...
	public void testForContinue() {
		decompileMethod("testForContinue",
	...
	public void testParamNames() {
		decompileMethod("testParamNames",
	...
	public void testForEachObjectAttribute() {
		decompileMethod("testForEachObjectAttribute",
				"var list:Array = null;\r\n" + "list = new Array();\r\n"
						+ "list[0] = \"first\";\r\n"
						+ "list[1] = \"second\";\r\n"
						+ "list[2] = \"third\";\r\n"
	...
	public void testMyPackage1TestInterface() {
		decompileScriptPack(
				"classes.mypackage1.TestInterface",
				"package classes.mypackage1\n"
						+ "{\n"
	...
	public void testMyPackage1MyNamespace() {
		decompileScriptPack(
				"classes.mypackage1.myNamespace",
				"package classes.mypackage1\n"
						+ "{\n"
	...
	public void testMyPackage2TestInterface() {
		decompileScriptPack("classes.mypackage2.TestInterface",
				"package classes.mypackage2\n" + "{\n"
	...
	public void testMyPackage3TestClass() {
		decompileScriptPack("classes.mypackage3.TestClass",
	...
	public void testOptionalParameters() {
		...
		abc.method_info.get(methodInfo).getParamStr(writer, abc.constants,
				abc.bodies.get(bodyIndex), abc, new ArrayList<>());
		String actualResult = writer.toText().replaceAll("[ \r\n]", "");
	...
	public void testManualConvert() {
		decompileMethod("testManualConvert",
